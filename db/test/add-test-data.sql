...
INSERT INTO quest (name, stars, questGiver, goal, subgoal, game) VALUES('The Unwavering Colossus', 5, 'Village', 'Hunt a Gammoth', 'Wound Gammoth''s legs', 'MHGen');
INSERT INTO quest (name, stars, questGiver, goal, subgoal, game) VALUES('Lagiacrus Fuss', 5, 'Village', 'Hunt a Lagiacrus', 'Mount and topple monster twice', 'MHGen');
...
INSERT INTO weapon (name, class, type) VALUES('Tempest Nightbow', 'Bow', 'Gunner');	INSERT INTO weapon (name, class, type) VALUES('Heavenly Storm', 'Bow', 'Gunner');
...
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Helm', 1, 'Head', 'Blademaster', 68, 1, 0, 0, 0, 0, 1, 106, 3, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Mail', 0, 'Torso', 'Blademaster', 68, 1, 0, 0, 0, 0, 1, 106, 2, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Braces', 0, 'Arms', 'Blademaster', 68, 1, 0, 0, 0, 0, 1, 106, 5, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Faulds', 1, 'Waist', 'Blademaster', 68, 1, 0, 0, 0, 0, 1, 123, 3, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Greaves', 2, 'Feet', 'Blademaster', 68, 1, 0, 0, 0, 0, 1, 123, 3, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Cap', 1, 'Head', 'Gunner', 34, 2, 0, 0, 0, 0, 1, 106, 4, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Vest', 0, 'Torso', 'Gunner', 34, 2, 0, 0, 0, 0, 1, 106, 2, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Guards', 0, 'Arms', 'Gunner', 34, 2, 0, 0, 0, 0, 1, 106, 4, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Coat', 1, 'Waist', 'Gunner', 34, 2, 0, 0, 0, 0, 1, 123, 3, 149, 0, 149, 0);
INSERT INTO armor (name, slots, part, type, defense, fire, water, thunder, ice, dragon, rarity, skill1, amount1, skill2, amount2, skill3, amount3) VALUES('Hunting Leggings', 2, 'Feet', 'Gunner', 34, 2, 0, 0, 0, 0, 1, 123, 3, 149, 0, 149, 0);
...
INSERT INTO hunter_art (name, gaugesize, description, weapon) VALUES('Lion''s Maw I', 290, 'Swings your Great Sword around your body with bloodthirsty force and raises the Attack of the following strike. This hellish Art leaves hunters with a demonic look in their eyes... and the battlefield littered with corpses.', 'Great Sword');
INSERT INTO hunter_art (name, gaugesize, description, weapon) VALUES('Lion''s Maw II', 350, 'Tier II raises the Attack of your next strike even higher.', 'Great Sword');
INSERT INTO hunter_art (name, gaugesize, description, weapon) VALUES('Lion''s Maw III', 500, 'Tier III raises the Attack of your next strike even higher than Tier II.', 'Great Sword');
INSERT INTO hunter_art (name, gaugesize, description, weapon) VALUES('Triple Volley I', 580, 'Fire off arrows in groups of three, with the final shot being the strongest. Fires in the direction you were facing upon activation.', 'Bow');
